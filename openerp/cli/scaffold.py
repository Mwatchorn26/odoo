...
# Developing for Interrogative mode set Program Arguments to:
# scaffold NewScaffoldTest ./addons/custom/ -i -t interrogative
# (omitting the # obviously)
...
env.filters['reverseSnake'] = reverseSnake
...
#                 while(True):
#                     selectionName=UserInputSnake('''_ State Name _ \n
#                                                Typical: [Child, Adult, Senior]\n
...
#              'states': ['Default', 'Open', 'Done', 'Cancel']}]}
    ...
    params={'models': [{'HasButtons': False,
             'HasSequence': False,
             'HasStates': False,
             'HasWizard': False,
             'IsWizard': False,
             'ModelDescription': 'Some long descrption of what TYPE is.',
             'ModelHasMenu': False,
             'ModelInherits': False,
             'ModelName': 'Type',
             'ModelSecurity': False,
             'NotebookPages': [],
             'fields': [{'FieldHelp': 'Some help text for the name field.',
                         'FieldInNotebook': False,
                         'FieldInTree': True,
                         'FieldName': 'name',
                         'FieldOnForm': True,
                         'FieldString': 'Event Type',
                         'FieldTreeVisible': True,
                         'FieldType': 'Char'},
                        {'FieldHelp': 'The useful help for Compound Name.',
                         'FieldInNotebook': False,
                         'FieldInTree': True,
                         'FieldName': 'compound_name',
                         'FieldOnForm': True,
                         'FieldString': 'Compound Name',
                         'FieldTreeVisible': True,
                         'FieldType': 'Char'}]}]}
